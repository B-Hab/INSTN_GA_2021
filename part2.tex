...
\begin{frame}[fragile]
	...
	\item Une question abordée très récemment dans le cadre du projet de recherche européen \includegraphics[width=1cm]{Figures/Logo_IVMR.pdf} ~(2015-2019) $\rightarrow$ \emph{illustration de la R\&D menée au CEA}
	\end{itemize}
\end{frame}
...
%%%%%%%%
\Intercalaire{La plateforme PROCOR et son approche statistique pour les accidents graves}
\section{La plateforme PROCOR et son utilisation}
\subsection{La plateforme PROCOR}
\Titre{La démarche phénoménologique dans PROCOR}
\begin{frame}[fragile]
	\vskip -0.8\baselineskip
	\begin{figure}[H]
	...
	\end{figure}
\end{frame}
\Titre{La plateforme physique et statistique PROCOR}
\begin{frame}[fragile]
	\vskip -0.8\baselineskip
	\begin{figure}[H]
	...
	\end{figure}
\end{frame}
\subsection{Évaluation du risque de percement de la cuve}
\Titre{Évaluation du risque de percement de la cuve par des analyses statisques}
\begin{frame}[fragile]
	\vskip -0.8\baselineskip
	\begin{figure}[H]
...
\begin{frame}[fragile]
	...
	\end{figure}
\end{frame}
\subsection{Calculs transitoires avec la plateforme PROCOR}
\Titre{Calculs transitoires avec la plateforme PROCOR : objectifs}
\begin{frame}[fragile]
	...
	\end{itemize}
\end{frame}
\Titre{Calculs transitoires avec la plateforme PROCOR : description des cas de test du benchmark}
\begin{frame}[fragile]
	\begin{columns}
	...
	\end{columns}
\end{frame}
\Titre{Calculs transitoires avec la plateforme PROCOR : lancement des calculs (1)}
\begin{frame}[fragile]
...
\end{itemize}
\end{frame}
\Titre{Calculs transitoires avec la plateforme PROCOR : lancement des calculs (2)}
\begin{frame}[fragile]
...
\end{itemize}
\end{frame}
\Titre{Calculs transitoires avec la plateforme PROCOR : lancement des calculs (3)}
\begin{frame}[fragile]
...
\end{itemize}
\end{frame}
\Titre{Calculs transitoires avec la plateforme PROCOR : démo sur le cas n$^{\circ}$1}
\begin{frame}[fragile]
\begin{itemize}
