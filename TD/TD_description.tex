...
Pour faciliter la réalisation de ce TD (en particulier, les questions des \Sects{rad}{param} qui ne peuvent pas être traitées analytiquement), il est accompagné de notebooks Jupyter (voir \href{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?filepath=TD?urlpath=lab}{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?filepath=TD?urlpath=lab}).
\end{abstract}
