...
\Q{Observer le transitoire de $\bar{\phi}^{oxy}_{up}$, le flux de chaleur moyen par la surface supérieure du bain oxyde.}
\Q{Observer le transitoire de $T_{met,FE}^{liq}$, la température moyenne de la couche d'acier liquide.}
...
\Q{Expliquer le transitoire des flux de chaleur imposés sur la paroie interne de la cuve et leur impact sur l'épaisseur de la cuve.}
\Q{Observer l'épaisseur $h^{liq.}_{met,FE}$ de la couche d'acier liquide.}
...
\subsection{Étude du cas 2}

\subsection{Étude du cas 3}
