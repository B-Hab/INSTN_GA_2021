...
Pour faciliter la réalisation de ce TD (en particulier, les questions des \Sects{rad}{param} qui ne peuvent pas être traitées analytiquement), il est accompagné de notebooks Jupyter (en local dans $\sim$/projet\_GA/seance1/TD et en ligne à \href{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab}{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab}).
\end{abstract}
