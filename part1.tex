...
\end{columns}
\vskip \baselineskip
\textit{cf.} description TD et notebooks Jupyter \\ {\scriptsize (\href{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab}{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab})}
\end{frame}