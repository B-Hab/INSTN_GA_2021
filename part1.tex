...
\end{columns}
\vskip \baselineskip
\textit{cf.} description TD et notebooks Jupyter \\ {\scriptsize en local dans $\sim$/projet\_GA/seance1/TD} \\ {\scriptsize en ligne à \href{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab}{https://mybinder.org/v2/gh/niamorelreillet/INSTN-GA-micro-projet.git/master?urlpath=lab}}
\end{frame}